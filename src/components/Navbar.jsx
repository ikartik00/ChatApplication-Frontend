...
//     return (
//         <header className="w-full px-4 sm:px-6 sticky top-0 z-50 bg-[#090d16]/90 border-b border-gray-800/80 text-gray-100 backdrop-blur-md shadow-lg">
...
//                             <NavLink 
//                                 to="/" 
//                                 className={({ isActive }) => `px-4 py-2 rounded-xl text-sm sm:text-base font-semibold transition-all duration-200 ${
//                                     isActive 
...
//             <div className={`md:hidden fixed inset-x-0 top-[64px] sm:top-[80px] bg-[#090d16]/98 border-b border-gray-800 backdrop-blur-2xl transition-all duration-300 ease-in-out z-40 transform origin-top ${
...
//                                     isActive ? "bg-indigo-600/10 text-indigo-400" : "text-gray-400 hover:bg-gray-800/40 text-gray-300"
//                                 }`}
//                             >
//                                 Home
//                             </NavLink>
